  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I'm a MERN Stack Developer with a frontend focus and 4+ years of
        experience building scalable, high-performance web apps using React,
        Next.js, TypeScript, and Material UI. I specialize in real-time
        features, data-intensive UIs, and reusable, maintainable component
        design. Passionate about creating seamless user experiences and
