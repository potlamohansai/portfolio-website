            ...
            <div className="qualification__sections">
                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active":"qualification__content"}>
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Software Development & Problem Solving</h3>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className='qualification__subtitle'>JNTU - Anantapur</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className='qualification__subtitle'>S.V University - Tirupati</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className='qualification__subtitle'>Govt. Polytechnic - Nellore</span>
                            <div className='qualification__calendar'>
                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active":"qualification__content"}>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">Assistant System Engineer</h3>
                            <span className='qualification__subtitle'>TCS - Bangalore</span>
                            <div className='qualification__calendar'>
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">Assistant System Engineer Trainee</h3>
                            <span className='qualification__subtitle'>TCS - Bangalore</span>
                            <div className='qualification__calendar'>
